...
#' from 1950 and reaching up to 2023. The dataset has the extension hist to indicate that these
#' are the historical data. There is a parallel dataset to this one with the extension proj to
#' indicate that the values are predictions or projections.
#'
#' @format A data frame with 16798 rows and 23 variables:
#' \describe{
